...
Gab has a small, fixed set of built-in types. This section is a reference for each one — its behaviour, its messages, and the details that matter when writing real code.
...
| `gab\message` | A self-typed atom value |
| `gab\block` | A closure / lambda |
